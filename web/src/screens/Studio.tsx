    ...
    <div className="space-y-4">
      <div className="card p-4" title="Brief">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <button className="btn-soft text-xs">Lock brief</button>
        </div>
      </div>
      <div className="card p-4" title="Variants">
        ...
        <div className="flex items-center gap-2 mt-2">
          <button className="btn-soft text-xs">Approve for test</button>
      ...
      <div className="card p-4" title="Quality">
        ...
        <div className="flex items-center gap-2 mt-2">
          <button className="btn-soft text-xs">Apply tone pass</button>
          <button className="btn-soft text-xs">Apply compliant rewrite</button>
        </div>
      </div>
    </div>
  );
