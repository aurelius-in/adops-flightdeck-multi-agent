    ...
    <div className="space-y-4">
      <div className="card p-4" title="Media buying cockpit">
        ...
        <div className="flex items-center gap-2 mt-3">
          <button className="btn-soft" onClick={()=>onQueue({ id: rid(), agent:"pacing", title:"Apply reallocation", impact:"+2.5% ROAS" })}>Apply reallocation</button>
        </div>
      </div>
      <div className="card p-4" title="Supply path optimization">
        ...
        <div className="flex items-center gap-2 mt-3">
          <button className="btn-soft" onClick={()=>onQueue({ id: rid(), agent:"spo", title:"Prune B>DSP2", impact:"-1.1% IVT" })}>Prune path</button>
        </div>
      </div>
